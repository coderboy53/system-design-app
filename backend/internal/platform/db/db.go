...
func InitializeDB() *sql.DB {
	...
	db, err := sql.Open("postgres", fmt.Sprintf("hostname=%s dbname=%s user=%s password=%s sslmode=disable", db_config["hostname"], db_config["dbname"], db_config["user"], db_config["password"]))
	if err != nil {
