...
est_minutes: 25
timelines: [long]
tags: [exercise, ood, chat, social-graph]
prerequisites: [interview-approach]
related: [exercise-social-graph, asynchronism]
source: https://github.com/donnemartin/system-design-primer/blob/master/solutions/object_oriented_design/online_chat/online_chat.ipynb
---
...
1. What workflows are in scope, and what is explicitly deferred?
2. How is the friend-request approval flow modeled?
3. What is the difference between a group chat and a private chat in this model?
