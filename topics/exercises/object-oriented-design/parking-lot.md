...
tags: [exercise, ood, inheritance, allocation]
prerequisites: [interview-approach]
related: []
source: https://github.com/donnemartin/system-design-primer/blob/master/solutions/object_oriented_design/parking_lot/parking_lot.ipynb
---
...
1. Which vehicle types can fit in which spot sizes?
2. What makes bus parking different from car and motorcycle parking?
3. Where does the 'can this vehicle fit this spot' decision live, and why there?
