...
tags: [exercise, ood, escalation, inheritance]
prerequisites: [interview-approach]
related: [asynchronism, microservices]
...
1. How does a call escalate from operator to supervisor to director?
2. What happens when nobody can answer the call?
3. Which class holds the dispatch logic, and why not the employee classes?
