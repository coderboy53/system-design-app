---
id: exercise-query-cache
title: Design a Key-Value Store for a Search Engine
module: exercises/system-design
order: 60
est_minutes: 25
timelines: [medium, long]
tags: [exercise, system-design, cache, lru, key-value]
prerequisites: [interview-approach]
related: [caching-overview, cache-update-strategies, key-value-store, cache-locations]
source: https://github.com/donnemartin/system-design-primer/blob/master/solutions/system_design/query_cache/README.md
---
...
![Diagram](../../../assets/images/KqZ3dSx.png)
...
![Diagram](../../../assets/images/4j99mhe.png)
...
* **The cache is [sharded](../../../data/sharding.md) across all machines in the cache cluster** - More complex, although it is likely the best option.  We could use hashing to determine which machine could have the cached results of a query using `machine = hash(query)`.  We'll likely want to use [consistent hashing](../../../appendix/under-development.md).
...
1. What two use cases define this system, and what happens on each?
2. Which data structures implement the LRU cache, and what does each contribute?
3. The cache stores query results. What is the key, and what is the value?
4. Name the three strategies for expanding the memory cache to many machines, and the trade-off of each.
5. Which of the three is likely best, and what hashing technique makes it workable?
6. What happens to a cached result when the underlying search results change?
