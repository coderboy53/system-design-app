...
tags: [reference, practice, interview-prep]
prerequisites: [interview-approach]
related: [real-world-architectures, company-architectures, interview-approach]
source: https://github.com/donnemartin/system-design-primer#additional-system-design-interview-questions
---
...
These have **no written solutions** — only reference links. That makes them the best practice
material once you've worked the [exercises with solutions](../exercises/system-design/README.md):
design each one yourself using the
[four-step framework](../study-guide/interview-approach.md) first, *then* read the references and
diff your design against what the references describe.
...
| Track | Coverage |
|---|---|
| [Short timeline](../study-guide/short-timeline.md) | Some |
| [Medium timeline](../study-guide/medium-timeline.md) | Many |
| [Long timeline](../study-guide/long-timeline.md) | Most |
